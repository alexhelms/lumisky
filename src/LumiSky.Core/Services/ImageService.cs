...
public static class ProcessTimingTracker
{
...
public class ImageService
{
    ...
    {
        using var _ = Benchmark.Start(t => ProcessTimingTracker.Add(new("Create Panorama", t)));
    ...
    {
        using var _ = Benchmark.Start(t => ProcessTimingTracker.Add(new("Load Raw Image", t)));
    ...
    {
        using var _ = Benchmark.Start(t => ProcessTimingTracker.Add(new("Debayer", t)));
        return Debayer.FromImage(image);
    }

    private double Median(AllSkyImage image)
    {
        using var _ = Benchmark.Start(t => ProcessTimingTracker.Add(new("Median", t)));
    ...
    private void AutoSCurve(AllSkyImage image)
    {
        ...
        {
            using var _ = Benchmark.Start(t => ProcessTimingTracker.Add(new("Auto S Curve", t)));
    ...
    {
        using var _ = Benchmark.Start(t => ProcessTimingTracker.Add(new("To 8-Bit Mat", t)));
    ...
    private void WhiteBalance(AllSkyImage image)
    {
        ...
        using var _ = Benchmark.Start(t => ProcessTimingTracker.Add(new("White Balance", t)));
    ...
    private void Rotate(Mat mat)
    {
        ...
        {
            using var _ = Benchmark.Start(t => ProcessTimingTracker.Add(new("Rotate", t)));
    ...
    private void FlipHorizontal(Mat mat)
    {
        ...
        {
            using var _ = Benchmark.Start(t => ProcessTimingTracker.Add(new("Flip Horizontal", t)));
    ...
    private void FlipVertical(Mat mat)
    {
        ...
        {
            using var _ = Benchmark.Start(t => ProcessTimingTracker.Add(new("Flip Vertical", t)));
    ...
    private void CircleMask(Mat mat)
    {
        ...
        {
            using var _ = Benchmark.Start(t => ProcessTimingTracker.Add(new("Circle Mask", t)));

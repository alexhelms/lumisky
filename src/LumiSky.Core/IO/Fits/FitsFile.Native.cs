...
namespace LumiSky.Core.IO.Fits;
...
public partial class FitsFile
{
    ...
    internal static unsafe partial class Native
    {
        ...
        [LibraryImport("cfitsio", EntryPoint = "ffinit", StringMarshalling = StringMarshalling.Utf8)]
        internal static partial ErrorCode CreateFile(ref nint handle, string filename, out ErrorCode status);
        ...
        [LibraryImport("cfitsio", EntryPoint = "ffgpv")]
        internal static partial ErrorCode ReadImage(nint handle, DataType datatype, long firstelem, long nelem, void* nulval, void* array, out int anynul, out ErrorCode status);

        [LibraryImport("cfitsio", EntryPoint = "ffcrimll")]
        internal static partial ErrorCode CreateImage(nint handle, ImageType bitpix, int naxis, long[] naxes, out ErrorCode status);
